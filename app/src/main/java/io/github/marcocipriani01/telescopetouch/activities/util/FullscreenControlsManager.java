...
public class FullscreenControlsManager {
    ...
    private static final String TAG = TelescopeTouchApp.getTag(FullscreenControlsManager.class);
    /**
    ...
    private final List<View> mViewsToHide;
    ...
    public FullscreenControlsManager(
        ...
        for (View buttonView : viewsToTriggerHide) {
             ...
             */
            View.OnTouchListener mDelayHideTouchListener = (View view, MotionEvent motionEvent) -> {
                if (AUTO_HIDE) {
