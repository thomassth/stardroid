...
class ApplicationModule(app: StardroidApplication) {
    ...
    fun provideLocationManager(): LocationManager {
        return ContextCompat.getSystemService(app, LocationManager::class.java) as LocationManager
    }
    ...
    fun provideSensorManager(): SensorManager {
        return ContextCompat.getSystemService(app, SensorManager::class.java) as SensorManager
    }

    @Provides
    @Singleton
    fun provideConnectivityManager(): ConnectivityManager {
        return ContextCompat.getSystemService(app, ConnectivityManager::class.java) as ConnectivityManager
    }
    ...
    fun provideLayerManager(
        ...
        layerManager.addLayer(NewStarsLayer(assetManager, resources))
        layerManager.addLayer(NewMessierLayer(assetManager, resources))
        layerManager.addLayer(NewConstellationsLayer(assetManager, resources))
        layerManager.addLayer(PlanetsLayer(model, resources, preferences))
