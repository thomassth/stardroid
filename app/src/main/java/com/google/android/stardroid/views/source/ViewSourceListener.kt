...
interface ViewSourceListener {
     ...
     */
    fun setPointSources(id: Int, s: List<PointPrimitive?>?)
     ...
     */
    fun setTextSources(id: Int, s: List<TextPrimitive?>?)
     ...
     */
    fun setImageSources(id: Int, s: List<ImagePrimitive?>?)
     ...
     */
    fun setPolyLineSources(id: Int, s: List<LinePrimitive?>?)
}